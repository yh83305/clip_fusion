...
# python video_recorder.py --dataset ~/dataset/collected_videos --video DESK --rate 60 --save
...
class RealSenseCamera:
    ...
    def run(self, output_dir=None):
        ...
        if output_dir is not None:
            ...
            np.savetxt(output_dir+'/camera-intrinsics.txt', cam_info['cam_intr'], fmt='%f', delimiter=' ')
...
def main():
    ...
    parser.add_argument('-v', '--video', default="0001", help='tb')
